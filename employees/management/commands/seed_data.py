...
class Command(BaseCommand):
    ...
    def create_employee_hierarchy(self, parent=None, depth=0, max_depth=7, max_children=5):
        if depth > max_depth:
            return
        ...
        for _ in range(num_children):
            ...
            self.create_employee_hierarchy(parent=employee, depth=depth + 1, max_depth=max_depth, max_children=max_children+1)
